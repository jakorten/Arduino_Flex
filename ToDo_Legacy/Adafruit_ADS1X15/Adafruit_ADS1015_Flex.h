...
#ifndef _ADAFRUIT_ADS1X15_FLEX_H
#define _ADAFRUIT_ADS1X15_FLEX_H
...
protected:
 ...
 public:
  Adafruit_ADS1015_Flex(TwoWire *wire, uint8_t i2cAddress = ADS1X15_ADDRESS);
  TwoWire *_wire;
  void begin(void);
...
class Adafruit_ADS1115_Flex : public Adafruit_ADS1015_Flex
{
 public:
  Adafruit_ADS1015_Flex(TwoWire *wire, uint8_t i2cAddress = ADS1X15_ADDRESS);
