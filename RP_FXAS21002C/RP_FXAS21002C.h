/***************************************************
  ...
  This modified version (RP_FXAS21002C) is used for SERCOM applications (ATSAMDxx)

  Usage:
  TwoWire sensorTWI(&sercom2, 4, 3);

  RP_FXAS21002C gyro = RP_FXAS21002C(&sensorTWI, 0x0021002C);



 ****************************************************/
#ifndef __RPFXAS21002C_H__
#define __RPFXAS21002C_H__
...
#include <Adafruit_Sensor.h> // might need to be changed as well...
#include <Wire.h>
...
class RP_FXAS21002C : public Adafruit_Sensor
{
  public:
    RP_FXAS21002C(int32_t sensorID = -1);
