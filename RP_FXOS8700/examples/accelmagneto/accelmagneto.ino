...
RP_FXOS8700 accelmag = RP_FXOS8700(0x8700A, 0x8700B);

// this example uses TwoWire instead of Wire (for SERCOM)
// J.A. Korten 2018
// Note: ToDo RP_FXAS21002C gyro = RP_FXAS21002C(&myWire, 0x0021002C);
